...
export class ClientsClient extends MonoCloudClientBase {
    ...
    constructor(configuration: MonoCloudConfig, baseUrl?: string, instance?: AxiosInstance) {
     ...
     */
    findClientById(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Client>> {
    ...
    protected processFindClientById(response: AxiosResponse): Promise<MonoCloudResponse<Client>> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<MonoCloudResponse<Client>>(new MonoCloudResponse<Client>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<Client>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<Client>>} Success
     */
    patchClient(id: string, body: PatchClientRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Client>> {
        let url_ = this.baseUrl + "/v1/clients/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPatchClient(response: AxiosResponse): Promise<MonoCloudResponse<Client>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    deleteClient(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/clients/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processDeleteClient(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    findClientSecretById(clientId: string, secretId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<SecretValue>> {
        ...
        if (secretId === undefined || secretId === null || secretId.toString().trim() === "")
    ...
    protected processFindClientSecretById(response: AxiosResponse): Promise<MonoCloudResponse<SecretValue>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<SecretValue>>(new MonoCloudResponse<SecretValue>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<SecretValue>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteClientSecret(clientId: string, secretId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/clients/{clientId}/secrets/{secretId}";
        if (clientId === undefined || clientId === null || clientId.toString().trim() === "")
            throw new Error("The parameter 'clientId' must be defined.");
        url_ = url_.replace("{clientId}", encodeURIComponent("" + clientId));
    ...
    protected processDeleteClientSecret(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<Client[]>>} Success
     */
    getAllClients(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Client[]>> {
    ...
    protected processGetAllClients(response: AxiosResponse): Promise<MonoCloudResponse<Client[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    createClient(body: CreateClientRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Client>> {
        let url_ = this.baseUrl + "/v1/clients";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateClient(response: AxiosResponse): Promise<MonoCloudResponse<Client>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            return Promise.resolve<MonoCloudResponse<Client>>(new MonoCloudResponse<Client>(status, _headers, result201));
     ...
     */
    createClientSecret(clientId: string, body: CreateSecretRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Secret>> {
    ...
    protected processCreateClientSecret(response: AxiosResponse): Promise<MonoCloudResponse<Secret>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            let resultData201  = _responseText;
            result201 = resultData201;
            return Promise.resolve<MonoCloudResponse<Secret>>(new MonoCloudResponse<Secret>(status, _headers, result201));
        ...
        return Promise.resolve<MonoCloudResponse<Secret>>(new MonoCloudResponse(status, _headers, null as any));
    }
}
...
export class KeysClient extends MonoCloudClientBase {
     ...
     */
    getAllKeyMaterials(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<KeyMaterial[]>> {
    ...
    protected processGetAllKeyMaterials(response: AxiosResponse): Promise<MonoCloudResponse<KeyMaterial[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<KeyMaterial[]>>(new MonoCloudResponse<KeyMaterial[]>(status, _headers, result200));

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<MonoCloudResponse<KeyMaterial[]>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     */
    rotateKey(keyId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
    ...
    protected processRotateKey(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<void>>} Success
     */
    revokeKey(keyId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
    ...
    protected processRevokeKey(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class LogsClient extends MonoCloudClientBase {
     ...
     */
    getAllLogs(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<LogSummary[]>> {
    ...
    protected processGetAllLogs(response: AxiosResponse): Promise<MonoCloudResponse<LogSummary[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<LogSummary[]>>(new MonoCloudResponse<LogSummary[]>(status, _headers, result200));

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<MonoCloudResponse<LogSummary[]>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     */
    findLogById(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Log>> {
    ...
    protected processFindLogById(response: AxiosResponse): Promise<MonoCloudResponse<Log>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<Log>>(new MonoCloudResponse<Log>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<Log>>(new MonoCloudResponse(status, _headers, null as any));
    }
}
...
export class OptionsClient extends MonoCloudClientBase {
     ...
     */
    patchAuthenticationOptions(body: PatchAuthenticationOptionsRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<AuthenticationOptions>> {
    ...
    protected processPatchAuthenticationOptions(response: AxiosResponse): Promise<MonoCloudResponse<AuthenticationOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<AuthenticationOptions>>(new MonoCloudResponse<AuthenticationOptions>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<AuthenticationOptions>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<AuthenticationOptions>>} Success
     */
    findAuthenticationOptions(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<AuthenticationOptions>> {
        let url_ = this.baseUrl + "/v1/options/authentication";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFindAuthenticationOptions(response: AxiosResponse): Promise<MonoCloudResponse<AuthenticationOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    patchBrandingOptions(body: PatchBrandingOptionsRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<BrandingOptions>> {
    ...
    protected processPatchBrandingOptions(response: AxiosResponse): Promise<MonoCloudResponse<BrandingOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<BrandingOptions>>(new MonoCloudResponse<BrandingOptions>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<BrandingOptions>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<BrandingOptions>>} Success
     */
    findBrandingOptions(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<BrandingOptions>> {
        let url_ = this.baseUrl + "/v1/options/branding";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFindBrandingOptions(response: AxiosResponse): Promise<MonoCloudResponse<BrandingOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    patchCommunicationOptions(body: PatchCommunicationOptionsRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<CommunicationOptions>> {
    ...
    protected processPatchCommunicationOptions(response: AxiosResponse): Promise<MonoCloudResponse<CommunicationOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<CommunicationOptions>>(new MonoCloudResponse<CommunicationOptions>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<CommunicationOptions>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<CommunicationOptions>>} Success
     */
    findCommunicationOptions(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<CommunicationOptions>> {
        let url_ = this.baseUrl + "/v1/options/communication";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFindCommunicationOptions(response: AxiosResponse): Promise<MonoCloudResponse<CommunicationOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    patchDeviceFlowOptions(body: PatchDeviceFlowOptionsRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<DeviceFlowOptions>> {
    ...
    protected processPatchDeviceFlowOptions(response: AxiosResponse): Promise<MonoCloudResponse<DeviceFlowOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<DeviceFlowOptions>>(new MonoCloudResponse<DeviceFlowOptions>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<DeviceFlowOptions>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<DeviceFlowOptions>>} Success
     */
    findDeviceFlowOptions(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<DeviceFlowOptions>> {
        let url_ = this.baseUrl + "/v1/options/device_flow";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFindDeviceFlowOptions(response: AxiosResponse): Promise<MonoCloudResponse<DeviceFlowOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    patchMtlsOptions(body: PatchMtlsOptionsRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<MtlsOptions>> {
    ...
    protected processPatchMtlsOptions(response: AxiosResponse): Promise<MonoCloudResponse<MtlsOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<MtlsOptions>>(new MonoCloudResponse<MtlsOptions>(status, _headers, result200));
     ...
     * @return {Promise<MonoCloudResponse<MtlsOptions>>} Success
     */
    findMtlsOptions(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<MtlsOptions>> {
        let url_ = this.baseUrl + "/v1/options/mtls";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFindMtlsOptions(response: AxiosResponse): Promise<MonoCloudResponse<MtlsOptions>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class ResourcesClient extends MonoCloudClientBase {
     ...
     */
    findApiResourceById(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiResource>> {
    ...
    protected processFindApiResourceById(response: AxiosResponse): Promise<MonoCloudResponse<ApiResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<ApiResource>>(new MonoCloudResponse<ApiResource>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<ApiResource>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<ApiResource>>} Success
     */
    patchApiResource(id: string, body: PatchApiResourceRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiResource>> {
        let url_ = this.baseUrl + "/v1/resources/apiresources/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPatchApiResource(response: AxiosResponse): Promise<MonoCloudResponse<ApiResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteApiResource(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/resources/apiresources/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processDeleteApiResource(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<SecretValue>>} Success
     */
    findApiResourceSecretById(resourceId: string, secretId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<SecretValue>> {
        let url_ = this.baseUrl + "/v1/resources/apiresources/{resourceId}/secrets/{secretId}";
        if (resourceId === undefined || resourceId === null || resourceId.toString().trim() === "")
    ...
    protected processFindApiResourceSecretById(response: AxiosResponse): Promise<MonoCloudResponse<SecretValue>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteApiResourceSecret(resourceId: string, secretId: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/resources/apiresources/{resourceId}/secrets/{secretId}";
        if (resourceId === undefined || resourceId === null || resourceId.toString().trim() === "")
            throw new Error("The parameter 'resourceId' must be defined.");
        url_ = url_.replace("{resourceId}", encodeURIComponent("" + resourceId));
    ...
    protected processDeleteApiResourceSecret(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    findApiScopeById(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiScope>> {
    ...
    protected processFindApiScopeById(response: AxiosResponse): Promise<MonoCloudResponse<ApiScope>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<ApiScope>>(new MonoCloudResponse<ApiScope>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<ApiScope>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<ApiScope>>} Success
     */
    patchApiScope(id: string, body: PatchApiScopeRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiScope>> {
        let url_ = this.baseUrl + "/v1/resources/apiscopes/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPatchApiScope(response: AxiosResponse): Promise<MonoCloudResponse<ApiScope>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteApiScope(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/resources/apiscopes/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processDeleteApiScope(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    findIdentityResourceById(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<IdentityResource>> {
    ...
    protected processFindIdentityResourceById(response: AxiosResponse): Promise<MonoCloudResponse<IdentityResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<IdentityResource>>(new MonoCloudResponse<IdentityResource>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<IdentityResource>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<IdentityResource>>} Success
     */
    patchIdentityResource(id: string, body: PatchIdentityResourceRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<IdentityResource>> {
        let url_ = this.baseUrl + "/v1/resources/identityresources/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPatchIdentityResource(response: AxiosResponse): Promise<MonoCloudResponse<IdentityResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteIdentityResource(id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/resources/identityresources/{id}";
        if (id === undefined || id === null || id.toString().trim() === "")
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processDeleteIdentityResource(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return {Promise<MonoCloudResponse<ApiResource[]>>} Success
     */
    getAllApiResources(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiResource[]>> {
    ...
    protected processGetAllApiResources(response: AxiosResponse): Promise<MonoCloudResponse<ApiResource[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    createApiResource(body: CreateApiResourceRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiResource>> {
        let url_ = this.baseUrl + "/v1/resources/apiresources";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateApiResource(response: AxiosResponse): Promise<MonoCloudResponse<ApiResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            let resultData201  = _responseText;
            result201 = resultData201;
            return Promise.resolve<MonoCloudResponse<ApiResource>>(new MonoCloudResponse<ApiResource>(status, _headers, result201));
     ...
     * @return {Promise<MonoCloudResponse<ApiScope[]>>} Success
     */
    getAllApiScopes(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiScope[]>> {
    ...
    protected processGetAllApiScopes(response: AxiosResponse): Promise<MonoCloudResponse<ApiScope[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    createApiScope(body: CreateApiScopeRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<ApiScope>> {
        let url_ = this.baseUrl + "/v1/resources/apiscopes";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateApiScope(response: AxiosResponse): Promise<MonoCloudResponse<ApiScope>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            let resultData201  = _responseText;
            result201 = resultData201;
            return Promise.resolve<MonoCloudResponse<ApiScope>>(new MonoCloudResponse<ApiScope>(status, _headers, result201));
     ...
     * @return {Promise<MonoCloudResponse<IdentityResource[]>>} Success
     */
    getAllIdentityResources(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<IdentityResource[]>> {
    ...
    protected processGetAllIdentityResources(response: AxiosResponse): Promise<MonoCloudResponse<IdentityResource[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    createIdentityResource(body: CreateIdentityResourceRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<IdentityResource>> {
        let url_ = this.baseUrl + "/v1/resources/identityresources";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateIdentityResource(response: AxiosResponse): Promise<MonoCloudResponse<IdentityResource>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            let resultData201  = _responseText;
            result201 = resultData201;
            return Promise.resolve<MonoCloudResponse<IdentityResource>>(new MonoCloudResponse<IdentityResource>(status, _headers, result201));
     ...
     * @return {Promise<MonoCloudResponse<Secret>>} Created
     */
    createApiResourceSecret(resourceId: string, body: CreateSecretRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Secret>> {
    ...
    protected processCreateApiResourceSecret(response: AxiosResponse): Promise<MonoCloudResponse<Secret>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class TenantsClient extends MonoCloudClientBase {
     ...
     */
    patchTenant(body: PatchTenantRequest , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Tenant>> {
    ...
    protected processPatchTenant(response: AxiosResponse): Promise<MonoCloudResponse<Tenant>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<Tenant>>(new MonoCloudResponse<Tenant>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<Tenant>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<Tenant>>} Success
     */
    findCurrentTenant(  cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<Tenant>> {
    ...
    protected processFindCurrentTenant(response: AxiosResponse): Promise<MonoCloudResponse<Tenant>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class UsersClient extends MonoCloudClientBase {
     ...
     */
    getAllUsers(page?: number | undefined, size?: number | undefined , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<UserSummary[]>> {
        let url_ = this.baseUrl + "/v1/users?";
        if (page === null)
            throw new Error("The parameter 'page' cannot be null.");
        else if (page !== undefined)
    ...
    protected processGetAllUsers(response: AxiosResponse): Promise<MonoCloudResponse<UserSummary[]>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<UserSummary[]>>(new MonoCloudResponse<UserSummary[]>(status, _headers, result200));

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<MonoCloudResponse<UserSummary[]>>(new MonoCloudResponse(status, _headers, null as any));
    }
     ...
     * @return {Promise<MonoCloudResponse<void>>} No Content
     */
    deleteUser(user_id: string , cancelToken?: CancelToken | undefined): Promise<MonoCloudResponse<void>> {
        let url_ = this.baseUrl + "/v1/users/{user_id}";
        if (user_id === undefined || user_id === null || user_id.toString().trim() === "")
            throw new Error("The parameter 'user_id' must be defined.");
        url_ = url_.replace("{user_id}", encodeURIComponent("" + user_id));
    ...
    protected processDeleteUser(response: AxiosResponse): Promise<MonoCloudResponse<void>> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    protected processPatchCustomDataKey(response: AxiosResponse): Promise<MonoCloudResponse<{ [key: string]: any; }>> {
        ...
        if (status === 200) {
            ...
            let resultData200  = _responseText;
            result200 = resultData200;
            return Promise.resolve<MonoCloudResponse<{ [key: string]: any; }>>(new MonoCloudResponse<{ [key: string]: any; }>(status, _headers, result200));
        ...
        return Promise.resolve<MonoCloudResponse<{ [key: string]: any; }>>(new MonoCloudResponse(status, _headers, null as any));
    }
...
export type DeviceFlowCodeTypes = typeof DeviceFlowCodeTypes[keyof typeof DeviceFlowCodeTypes];
...
export type KeyMaterialTypes = typeof KeyMaterialTypes[keyof typeof KeyMaterialTypes];
...
export type KeyMaterialUses = typeof KeyMaterialUses[keyof typeof KeyMaterialUses];
...
export type LogEventCategories = typeof LogEventCategories[keyof typeof LogEventCategories];
...
export type RefreshTokenExpirationTypes = typeof RefreshTokenExpirationTypes[keyof typeof RefreshTokenExpirationTypes];
...
export type SigningAlgorithms = typeof SigningAlgorithms[keyof typeof SigningAlgorithms];
...
export type X509RevocationMode = typeof X509RevocationMode[keyof typeof X509RevocationMode];
